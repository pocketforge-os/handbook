...
The current carrier-link set contains two **91.5 mm upper links** and two
**108.5 mm lower links**. Installed at the unchanged rail and carrier-hole
datums, both pairs stop 1 mm inside the lower and upper chassis stack planes.
...
Next: [generate and print the Smart Pro pack](../../devices/trimui-smart-pro/print.md).
