...
<div class="pf-step-visual">
  <figure>
    <img src="../../../../../../assets/generated/test-node-chassis/legacy/qualified-gantry-complete.png" alt="Simplified complete mechanical chassis with newly installed printed hardware highlighted in orange">
...
## Do this · compare the build

- [ ] Operator side: placard above; the unplugged power-strip switch remains
      reachable on the lower-right depth rail.
...
**Before you continue:** mark the assembly chapter complete only when every
item above matches the reference and the build remains unpowered. Continue to
the full verification gates before wiring or stacking a populated node.
