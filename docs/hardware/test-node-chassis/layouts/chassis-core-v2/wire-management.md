...
<p class="pf-profile-banner" data-guide-device="trimui-smart-pro" data-layout-id="chassis-core-v2"><strong>Selected build:</strong> TrimUI Smart Pro <span>·</span> <code>chassis-core-v2</code></p>
...
browser](../../devices/trimui-smart-pro/print.md#generate-one-cable-anchor).
