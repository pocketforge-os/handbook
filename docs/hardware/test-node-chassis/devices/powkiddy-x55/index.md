...
<p class="pf-profile-banner" data-guide-device="powkiddy-x55" data-layout-id="chassis-dualbar-powkiddy-x55-v1"><strong>Selected DUT:</strong> Powkiddy X55 <span>·</span> <strong>Layout:</strong> <code>chassis-dualbar-powkiddy-x55-v1</code></p>
...
| Chassis layout | `chassis-dualbar-powkiddy-x55-v1` · side-clear continuous bars plus X55 carrier links |
...
| Assembly sequence | 17 continuous-bar page-per-job bench steps |
