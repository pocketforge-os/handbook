...
<p class="pf-profile-banner" data-guide-device="trimui-smart-pro" data-layout-id="chassis-dualbar-smart-pro-v1"><strong>Selected DUT:</strong> TrimUI Smart Pro / TG5040 <span>·</span> <strong>Layout:</strong> <code>chassis-dualbar-smart-pro-v1</code></p>
...
| Chassis layout | `chassis-dualbar-smart-pro-v1` · side-clear continuous-bar chassis |
