...
[Choose the exact DUT](../index.md) and open the assembly chapter from its build
sheet. Smart Pro uses the qualified 19-step gantry lane; Smart Pro S uses the
17-step dual-bar candidate lane.
