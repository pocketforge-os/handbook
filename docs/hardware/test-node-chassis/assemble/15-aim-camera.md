...
<div class="pf-step-visual">
  <figure>
    <img src="../../../../assets/generated/test-node-chassis/detail-07-optical-axis.png" alt="Blue webcam field-of-view cone extending from the electronics plate to surround the complete DUT on the opposite holder">
